...
| Instrumented tests | `./gradlew connectedAndroidTest` | Device-backed paths: lazysodium native `.so` ABI loading, Android Keystore wrap/unwrap, Room migrations. Requires emulator/device in CI. |
