...
Source: PM feature selection 2026-06-06 (next-step choice "X25519 + fix D10"); scope settled with PM to "D10 fix + remote private chats". Backlog: "X25519 identity (NEAR-TERM)" + the D10 blocker in `.ai-dev/backlog.md` "Feature blockers recorded from quality sweep".
